...
%--------------------------------------------------------------------------
% This function takes Outer Leaves analog information, combined with Inner Leaves Error, and calculates the 6State protocol E2E Rate
k_main = min(K_each);
...
%--------------------------------------------------------------------------
% Outer Leaves information coming from the left channel
...
%--------------------------------------------------------------------------
% Outer Leaves information coming from the right channel
...
%--------------------------------------------------------------------------
% Calculating the E2E rate while the resource states error are different 
