The Question is ?? Having a fix k_total what distribution [k_1, k_2, k_3] is optimal for the setting [l_1, l_2, l_3] ??

For a given client distant and resource allocation, how to calculate the final rate >>
